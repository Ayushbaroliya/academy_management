...
const Dashboard = () => {
  ...
  return (
    <div className="pb-32 pt-8 px-6 overflow-y-auto h-full">
      <motion.header 
      ...
      >
        <div>
          <h1 className="text-2xl font-bold text-white">Hey, Coach! 👋</h1>
          <p className="text-gray-400 text-sm">Wednesday, 13 May 2026</p>
        </div>
      ...
      >
        <motion.div variants={itemVariants} className="bento-item-large glass-accent rounded-3xl p-6 relative overflow-hidden">
          <div className="relative z-10">
            <p className="text-accent text-xs font-bold uppercase tracking-widest mb-1">Total Impact</p>
            <h2 className="text-4xl font-bold text-white mb-4">{stats.totalStudents}</h2>
            <div className="flex items-center gap-2 text-accent text-sm bg-accent/10 w-fit px-3 py-1 rounded-full border border-accent/20">
              <TrendingUp size={14} />
        ...
        {/* Small Cards */}
        <motion.div variants={itemVariants} className="glass rounded-3xl p-5 flex flex-col justify-between aspect-square">
          ...
          <div>
            <p className="text-gray-400 text-xs font-medium">Present</p>
        ...
        <motion.div variants={itemVariants} className="glass rounded-3xl p-5 flex flex-col justify-between aspect-square">
          ...
          <div>
            <p className="text-gray-400 text-xs font-medium">Absent</p>
        ...
        <motion.div variants={itemVariants} className="glass rounded-3xl p-5 flex flex-col justify-between aspect-square">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-white">{stats.pendingFees}</h3>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="glass rounded-3xl p-5 flex flex-col justify-between aspect-square">
          ...
          <div>
            <p className="text-gray-400 text-xs font-medium">Hostel</p>
            <h3 className="text-2xl font-bold text-white">{stats.hostelers}</h3>
          </div>
        </motion.div>
      </motion.div>
      ...
      {/* Quick Actions */}
      <div className="mt-10">
        <h3 className="text-white font-bold mb-4 ml-1">Quick Actions</h3>
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            >
              <div className={`${action.color === 'bg-accent' ? 'bg-amber-500' : action.color === 'bg-orange' ? 'bg-orange-500' : action.color} w-16 h-16 rounded-2xl flex items-center justify-center shadow-md text-white`}>
                <action.icon size={28} />
              </div>
              <span className="text-[11px] text-gray-400 font-medium text-center">{action.label}</span>
            </motion.button>
          ))}
        </div>
      </div>
